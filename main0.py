...
def main(fea):
    ...
    output_filename = f'output_{fea}.txt'
    best_output_filename = f'best_output_{fea}.txt'
...
####miRNAz特征视图
    ...
    for epoch in range(1, 1000):
        ...
        with open(best_output_filename, 'w') as f:
            f.write(
    ...
    # 输出AUC最大的结果
    with open(best_output_filename, 'a+') as f:
        f.write(
            f'{best_result[0]} {best_result[1]} {best_result[2]} {best_result[3]} {best_result[4]} {best_result[5]}\n')
    methods.save_to_excel(best_labels, best_preds,max_AUC,fea)
